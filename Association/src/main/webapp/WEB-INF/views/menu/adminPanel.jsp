...
<ul>
	...
	<li><a href="#" accesskey="3" title=""><spring:message code="menu.building"/></a></li>
	<li><a href="#" accesskey="4" title=""><spring:message code="menu.renters"/></a></li>
	<li><a href="#" accesskey="5" title=""><spring:message code="menu.account"/></a></li>
