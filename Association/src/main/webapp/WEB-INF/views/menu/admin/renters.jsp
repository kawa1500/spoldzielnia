...
<ul>
	...
	<li><a href="adminBuilding.html" accesskey="3" title=""><spring:message code="menu.building"/></a></li>
	<li class="active"><a href="#" accesskey="4" title=""><spring:message code="menu.renters"/></a></li>
